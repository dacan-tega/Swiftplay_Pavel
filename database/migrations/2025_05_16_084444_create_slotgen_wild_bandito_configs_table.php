...
return new class extends Migration
{
    ...
    {
        Schema::create('slotgen_wild_bandito_configs', function (Blueprint $table) {
            $table->id();
        ...
        DB::table('slotgen_wild_bandito_configs')->insert(
            [
                'win_ratio' => 50,
                'feature_ratio' => 50,
                'feature_winvalue' => 50,
    ...
    {
        Schema::dropIfExists('slotgen_wild_bandito_configs');
    }
};
