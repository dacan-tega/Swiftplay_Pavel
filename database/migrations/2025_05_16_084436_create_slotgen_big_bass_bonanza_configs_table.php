...
return new class extends Migration
{
    ...
    {
        Schema::create('slotgen_big_bass_bonanza_configs', function (Blueprint $table) {
            $table->id();
        ...
        DB::table('slotgen_big_bass_bonanza_configs')->insert(
            [
                'win_ratio' => 50,
                'feature_ratio' => 50,
                'feature_winvalue' => 50,
...
'jackpot_value' => 20,
    ...
    {
        Schema::dropIfExists('slotgen_big_bass_bonanza_configs');
    }
};
