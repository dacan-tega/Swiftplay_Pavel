    ...
    public static function sidebar(Model $record): FilamentPageSidebar
    {
        return FilamentPageSidebar::make()
            ...
            ->setNavigationItems([
                ...
                PageNavigationItem::make(__('admin.change_password'))
                    ->translateLabel()
                ...
                Forms\Components\Section::make()
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('email')
                            ->label('E-mail')
                            ->placeholder(__('admin.Enter_mail'))
                            ->email()
                            ->required()
                            ->maxLength(191),
                        Forms\Components\TextInput::make('cpf')
                            ->label('CPF')
                            ->placeholder(__('admin.Enter_CPF'))
                            ->maxLength(191),
                        ...
                        Forms\Components\Select::make('inviter')
                            ->label(__('admin.Affiliate'))
                            ->placeholder(__('admin.Select_affiliate'))
