...
use Slotgen\SlotgenWildBandito\SlotgenWildBanditoPlugin;
use Slotgen\SlotgenGatesOfOlympus\SlotgenGatesOfOlympusPlugin;
use Slotgen\SlotgenSweetBonanza\SlotgenSweetBonanzaPlugin;
use Slotgen\SlotgenBigBassBonanza\SlotgenBigBassBonanzaPlugin;
...
class AdminPanelProvider extends PanelProvider
{
    ...
    public function panel(Panel $panel): Panel
    {
        ...
        return $panel
            ...
            ->plugins([
                SlotgenWildBanditoPlugin::make(),
                SlotgenGatesOfOlympusPlugin::make(),
                SlotgenSweetBonanzaPlugin::make(),
                SlotgenBigBassBonanzaPlugin::make(),
            ])
            ->sidebarCollapsibleOnDesktop()
            ->navigation(function (NavigationBuilder $builder): NavigationBuilder {
                return $builder->groups([
                    ...
                    // ->items([
                    //     SlotgenFortuneTigerPlugin::make()->getNavigationItemsTest(),
                    // ]),
                    ...
                    NavigationGroup::make()
                        ->items([
                            ...
                            NavigationItem::make('suitpay-pagamentos')
                                ...
                                ->label(fn(): string => __('admin.Report'))
                                ->url(fn(): string => OrderResource::getUrl())
                                ->isActiveWhen(fn() => request()->routeIs('filament.pages.suit-pay-payment-page'))
                                ->visible(fn(): bool => auth()->user()->hasRole('admin')),
                        ]),

                    SlotgenWildBanditoPlugin::make()->getNavigationItems(),
                    SlotgenGatesOfOlympusPlugin::make()->getNavigationItems(),
                    SlotgenSweetBonanzaPlugin::make()->getNavigationItems(),
                    SlotgenBigBassBonanzaPlugin::make()->getNavigationItems(),
                    ...
                    auth()->user()->hasRole('admin') ?
                        NavigationGroup::make(__('admin.Providers'))
                        ->items([
