...
class ResetPasswordController extends Controller
{
    ...
    public function sendResetLink(Request $request)
    {
        ...
        if (!$user) {
            return response()->json(['message' => __('admin.Email_not_found')], 404);
        }
        ...
        return response()->json(['message' => __('admin.Password_reset_link')]);
    }
    ...
    public function showResetPasswordForm($token)
    {
        ...
        if (!$resetRecord) {
            abort(404,  __('admin.Invalid_expired_token'));
        }
    ...
    public function resetPassword(Request $request, $token)
    {
        ...
        if (!$user) {
            abort(404, __('admin.User_not_found'));
        }
