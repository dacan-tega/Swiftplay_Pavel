...
namespace Slotgen\SlotgenBigBassBonanza\Http\Controllers\Site;
...
class GameController extends AppBaseController
{
    ...
    public function rtpSimulate(Request $req)
    {
        ...
        // $player = auth()->user();
        // $playerId = $player->id;
        // $playerGame = BigBassBonanzaPlayer::where("player_uuid",$playerId)->first();
        ...
        $ip = SlotgenBigBassBonanza::getIp($req);
        $data = [
            'device_info' => $agent,
            'client_ip' => $ip,
        ];
        $launchData = SlotgenBigBassBonanza::checkPlayer($player, $data);
        $launchGameRes = (object) SlotgenBigBassBonanza::LaunchGame($launchData);
