...
namespace Slotgen\SlotgenBigBassBonanza\Filament\Pages;
...
use Slotgen\SlotgenBigBassBonanza\Models\SlotgenGame;
...
class SlotgenBigBassBonanzaConfigPage extends Page
{
    use InteractsWithForms;

    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'slotgen-bigbassbonanza::filament.pages.config-page';

    public ?array $data = [];

    public SlotgenBigBassBonanzaConfig $setting;

    public function mount(): void
    {
        $rtpConfig = SlotgenBigBassBonanzaConfig::first();
        if (! empty($rtpConfig)) {
    ...
    public function submit(): void
    {
        ...
        try {
            // dd($this->data);
            $setting = SlotgenBigBassBonanzaConfig::first();
            if (! empty($setting)) {
                ...
                // dd($this->data);
                if (SlotgenBigBassBonanzaConfig::create($this->data)) {
                    Notification::make()
                        ->title('Setting add')
    ...
    public function extractFile($fileName, $language = 'en')
    {
        ...
        if ($folder != null) {
            ...
            // $data = [
            //     'game_name'        => $name,
            //     'game_class'     => "Slotgen\\SlotgenBigBassBonanza\\SlotgenBigBassBonanza",
            // ];
            // $slotgen->fill($data);
            // $slotgen->save();
            $gamePrivateFolder = storage_path('app/private/big_bass_bonanza');
            $localtionStorage = 'app/private/big_bass_bonanza';
            ...
            $time = time();
            $gameName = 'big_bass_bonanza' . '-' . $time;
            ...
            //File::copy(__DIR__ . '/../../../resources/games/bigbassbonanza-logo.png', $gamePublicFolder . '/bigbassbonanza-logo.png');
        }
    }
}
