...
namespace Slotgen\SlotgenWildBandito\Filament\Pages;
...
use Slotgen\SlotgenWildBandito\Models\SlotgenGame;
use Slotgen\SlotgenWildBandito\Models\SlotgenWildBanditoConfig;
use Yepsua\Filament\Forms\Components\RangeSlider;
use Filament\Forms\Components\Select;
use ZipArchive;

class SlotgenWildBanditoConfigPage extends Page
{
    use InteractsWithForms;

    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'slotgen-wildbandito::filament.pages.config-page';

    public ?array $data = [];

    public SlotgenWildBanditoConfig $setting;

    public function mount(): void
    {
        $rtpConfig = SlotgenWildBanditoConfig::first();
        if (! empty($rtpConfig)) {
    ...
    public function submit(): void
    {
        ...
        try {
            // dd($this->data);
            $setting = SlotgenWildBanditoConfig::first();
            if (! empty($setting)) {
                ...
                // dd($this->data);
                if (SlotgenWildBanditoConfig::create($this->data)) {
                    Notification::make()
                        ->title('Setting add')
    ...
    public function extractFile($fileName, $language = 'en')
    {
        ...
        if ($folder != null) {
            ...
            // $data = [
            //     'game_name'        => $name,
            //     'game_class'     => "Slotgen\\SlotgenWildBandito\\SlotgenWildBandito",
            // ];
            // $slotgen->fill($data);
            // $slotgen->save();
            $gamePrivateFolder = storage_path('app/private/wild_bandito');
            $localtionStorage = 'app/private/wild_bandito';
            ...
            //File::copy(__DIR__ . '/../../../resources/games/wildbandito-logo.png', $gamePublicFolder . '/wildbandito-logo.png');
        }
    }
}
