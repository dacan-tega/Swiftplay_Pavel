                ...
                success: function(data) {
                    ...
                    for (let i = 0; i < items.length; i++) {
                        ...
                        for (let j = 0; j < countItem; j++) {
                            ...
                            var multiply = item[j]['total_multi'];
                            var symbolReel = item[j]['new_reel'];
                            var position = item[j]['drop_position'];
                            var winDrop = item[j]['win_drop'];
                            var symbolScatter = "symbol_1_0";
                            var credit = item[j]['credit_drop']
                            var multilFire = item[j]['multi_fire'] ? item[j]['multi_fire'] : "";
                            var multilIce = item[j]['multi_ice'] ? item[j]['multi_ice'] : "";
                            var multilLeaf = item[j]['multi_leaf'] ? item[j]['multi_leaf'] : "";
                            var profit = item[j]['profit'];
                            // var xReel1 = multilReel1 ? "mul_x" : "";
                            // var xReel2 = multilReel2 ? "mul_x" : "";
                            // var xReel3 = multilReel3 ? "mul_x" : "";
                            var freeSpinRequired = item[j]['freespin_require'];
                            var payout = "";
                            var multil = "";
                            var multilLight = "";

                            var multiList = item[j]['multi_list']
                            console.log("####");
                            for (let c = 0; c < multiList.length; c++) {
                                if (c == 0) {
                                    multil = multil + `<div id="multiplier_box" style="position: absolute; height: 28px; width: 57px;">
                                                <div class="mahjong_static_sprites multiplier_x${multiList[c]}_grey"
                                                    style="margin: -4px 60px; transform-origin: left top; transform: scale(0.3333);"></div>
                                            </div>`;
                                }
                                if (c == 1) {
                                    multil = multil + `<div id="multiplier_box" style="position: absolute; height: 28px; width: 57px;">
                                                <div class="mahjong_static_sprites multiplier_x${multiList[c]}_grey"
                                                    style="margin: -4px 100px; transform-origin: left top; transform: scale(0.3333);"></div>
                                            </div>`;
                                }
                                if (c == 2) {
                                    multil = multil + `<div id="multiplier_box" style="position: absolute; height: 28px; width: 57px;">
                                                <div class="mahjong_static_sprites multiplier_x${multiList[c]}_grey"
                                                    style="margin: -4px 140px; transform-origin: left top; transform: scale(0.3333);"></div>
                                            </div>`;
                                }
                                if (c == 3) {
                                    multil = multil + `<div id="multiplier_box" style="position: absolute; height: 28px; width: 57px;">
                                                <div class="mahjong_static_sprites multiplier_x${multiList[c]}_grey"
                                                    style="margin: -4px 180px; transform-origin: left top; transform: scale(0.3333);"></div>
                                            </div>`;
                                }
                            ...
                            if (j == 0) {
                                multilLight = `<div id="multiplier_light_box" style="margin: 3px 60px; transform-origin: left top; transform: scale(0.3333);">
                                    <div class="mahjong_static_sprites multiplier_glow"
                                        style="position: absolute; margin: -929px 5px; transform-origin: left top; transform: scale(1.5);"></div>
                                    <div class="mahjong_static_sprites multiplier_x${multiList[j]}_light" style="position: absolute; margin: -901px 0px;"></div>
                                </div>`;
                            }
                            ...
                            if (j == 1) {
                                multilLight = `<div id="multiplier_light_box" style="margin: 3px 60px; transform-origin: left top; transform: scale(0.3333);">
                                    <div class="mahjong_static_sprites multiplier_glow"
                                        style="position: absolute; margin: -929px 125px; transform-origin: left top; transform: scale(1.5);"></div>
                                    <div class="mahjong_static_sprites multiplier_x${multiList[j]}_light" style="position: absolute; margin: -901px 120px;"></div>
                                </div>`;
                            }
                            ...
                            if (j == 2) {
                                multilLight = `<div id="multiplier_light_box" style="margin: 3px 60px; transform-origin: left top; transform: scale(0.3333);">
                                    <div class="mahjong_static_sprites multiplier_glow"
                                        style="position: absolute; margin: -929px 245px; transform-origin: left top; transform: scale(1.5);"></div>
                                    <div class="mahjong_static_sprites multiplier_x${multiList[j]}_light" style="position: absolute; margin: -901px 240px;"></div>
                                </div>`;
                            }

                            if (j > 2) {
                                var newJ = multiList.length - 1;
                                multilLight = `<div id="multiplier_light_box" style="margin: 3px 60px; transform-origin: left top; transform: scale(0.3333);">
                                    <div class="mahjong_static_sprites multiplier_glow"
                                        style="position: absolute; margin: -929px 365px; transform-origin: left top; transform: scale(1.5);"></div>
                                    <div class="mahjong_static_sprites multiplier_x${multiList[newJ]}_light" style="position: absolute; margin: -901px 360px;"></div>
                                </div>`;
                            }

                            var multilReel = multil + multilLight
                            payout = payout + `
                            ...
                            if (winDrop !== 0) {
                                ...
                                <div style="width: 285px; height: 48px; align-self: start;">
                                        <div class="payoutContainer"
                                            ...
                                            <div class="mahjong_static_sprites base_white" style="transform-origin: left top; transform: scale(0.25);">
                                            <span class="${symbolWin['name']}_1 symbol_atlas"
                                                    style="transform-origin: left top; transform: scale(1);margin-top: 19px; margin-left: 53px;"></span>
                                                    </div>
                                            </div>
                                            <div class="payoutDescContainer"
                                            ...
                                            <div style="display: flex; flex-direction: column; justify-content: center; text-align: right; width: auto;"><span
                                                style="font-size: 14px; line-height: 18px; color: rgb(204, 204, 204);">${symbolWin['win_multi']}</span><span
                                                style="font-size: 11px; line-height: 14px; color: rgb(156, 155, 155);">${symbolWin['win_total']} x ${symbolWin['total_multi']}</span></div>
                                            </div>
                                            ...
                                            <div id="tooltip"
                                                ...
                                                <div id="tooltip-toast"
                                                    ...
                                                    <div id="tooltip-title" style="color: rgb(128, 128, 128); font-size: 12px; text-align: left; padding: 0px 8px;">
                                                        Bet Size x Bet Level x Symbol Payout Values x Way(s) x Multiplier
                                                    </div>
                                                    <div id="tooltip-desc" style="font-size: 12px; text-align: left; padding: 0px 8px;">${betSize} x ${betLevel} x ${symbolWin['payout']} x ${symbolWin['ways']} x ${symbolWin['total_multi']}
                                                    </div>
                                                </div>
                                            </div>
                                    </div>
                            ...
                            if (!freeMode && winDrop == 0 && freeNum > 0) {
                                ...
                                <div class="payoutContainer"
                                    ...
                                    <div class="payoutTextContainer"
                                        ...
                                        <div class="payoutTitle" style="font-size: 12px; color: rgb(255, 255, 255); text-align: right;">${freeSpin} Free Spin(s)
                                        </div>
                                    </div>
                                </div>
                            ` + payout;
                            ...
                            if (freeMode && countScatter > freeSpinRequired && winDrop == 0) {
                            ...
                            <div id="payout-title-container"
                                style="display: flex; width: inherit; height: 81px; justify-content: center; align-items: center; margin: 0px auto;">
                        ...
                        `
                            ...
                            var slotColumn = "";
                            for (let c = 0; c < countLastReel + 1; c++) {
                                var slotItem = "";
                                for (let d = 1; d < symbolReel[c].length; d++) {
                                    console.log(symbolReel);
                                    var symbol = symbolReel[c][d];
                                    var imagesSymbol = symbolReel[c][d] == "symbol_1" || symbolReel[c][d] == "symbol_0" ? "special_symbol_atlas" : "symbol_atlas";
                                    var check = c + d * 6 + 1;
                                    var blank = "width: 52px; height: 58px;";
                                    var whCheck = symbol == "_blank" ? "" : symbol.slice(-1);
                                    var baseWhite = symbol == "symbol_1_0" || symbol == "symbol_0_0" ? "" : "base_white";
                                    ...
                                    <span class="mahjong_static_sprites ${baseWhite}" style="margin-top : -5px; margin-left : -12px;display: block; position: absolute; transform-origin: left top; transform: scale(0.3333);"></span>
                                    <span
                                    class="${symbol} ${imagesSymbol}"
                                    style="display: block; position: absolute; transform-origin: left top; transform: scale(0.3333) translate(10px, 0px);"></span>
                                    <div id="win-highlight-item"><span class="history_assets wh_${wh}" style="display: block; position: absolute; transform-origin: left top; margin-top: -10px; margin-left: -10px; transform: scaleX(0.5) scaleY(0.47); z-index: 1;"></span></div>
                                    </div>
                            ...
                            for (let c = 0; c < lastReel.length; c++) {
                                ...
                                //                             <div id="slot-item" style="width: 52px; height: 58px;"><span
                                //                                 class="${lastReel[c]} ${imagesSymbol}"
                                //                                 style="display: block; position: absolute; transform-origin: left top; margin-top: -10px; margin-left: -10px; transform: scaleX(0.39) scaleY(0.39); z-index: 1;"></span>
                                //                                 <div id="win-highlight-item"><span class="wh symbol_atlas" style="display: block; position: absolute; transform-origin: left top; margin-top: -10px; margin-left: -10px; transform: scaleX(0.39) scaleY(0.39); z-index: 1;"></span></div> 
                                //                         </div>
                            ...
                            transactionItem = `
                                            ...
                                            <div id="transaction-details-container"
                                                ...
                                                <div class="transaction-detail-item"
                                                    ...
                                                    <div id="Bet(฿)-item-key" style="text-align: center; font-size: 11px; color: rgb(224, 111, 54);">Bet(${currency})
                                                    </div>
                                                </div>
                                                <div class="transaction-detail-item"
                        ...
                        `
                            var page = $(`<div class="game-list-page" style="width: 100%; height: 578px; position: absolute; left: ${slideCss}px;">
                                    <div class="reset">` + transactionItem + ` <div class="history regular" style="width: inherit; height: 700px;">
                                            <div class=" rcs-custom-scroll " style="height: inherit;">
                                                <div class="rcs-outer-container" style="height: 100%;">
                                                    ...
                                                    <div class="rcs-inner-container" style="height: 100%; margin-right: -17px;">
                                                        <div style="height: 850px; overflow-y: visible; margin-right: 0px;">
                                                            <div id="bet-details-container" style="display: flex; flex-direction: column;">` + betInformation + `<div id="slot-main-view" style="display: flex; width: 300px; margin: auto;">
                                                                    <div id="bet-results-container"
                                                                        ...
                                                                        <div><span class="history_assets bg_main" id="slot-background"
                                                                                style="display: block; position: absolute; transform-origin: left top; transform: scaleX(0.3) scaleY(0.3); top: -12px; left: -8px; z-index: 0; margin-top: 3px; margin-left: 47px;"></span>
                                                                        </div>
                                                                        <div id="train-symbols-container"
                                                                            style="position: relative; min-width: 38.25px; width: 38.25px; height: inherit; display: flex; flex-direction: row; margin-top: auto; margin-bottom: auto;">` + trainSymbol + `
                                                                            </div>
                                                                        <div id="space" style="height: 4px;"></div>
                                                                        <div id="symbols-container"
                                                                            style="position: relative; min-width: 38.25px; width: 38.25px; height: inherit; display: flex; flex-direction: row; margin-top: auto; margin-bottom: auto;margin-left: 33px;">` + slotColumn + `
                                                                            </div>` +
                                multilReel + `
                                                                    </div>
                                                                </div>` + payoutTitle + `<div id="payout-main-view"
                                                                    style="display: flex; justify-content: space-between; flex-direction: column; align-items: center; width: inherit; margin-top : -38px;">
                                                                    <div id="payout-main-view"
                                                                        style="display: flex; justify-content: space-between; flex-direction: column; align-items: center; width: inherit; margin: auto;">
                                                                        </div>` + payout + `
                                                                        </div>
...
<style>
    ...
    .symbol_atlas {
        ...
        overflow: hidden;
        background-repeat: no-repeat;
        background-image: url({{$gamePublicFolder}}/20.png)
    }
    ...
    .symbol_5_0 {
        height: 140px;
        width: 95px;
        background-position: -1119px -79px;
    }
    ...
    .symbol_7_0 {
        height: 140px;
        width: 95px;
        background-position: -1446px -77px;
    }
    ...
    .symbol_8_0 {
        height: 140px;
        width: 95px;
        background-position: -1575px -80px;
    }
    ...
    .history_assets {
        ...
        overflow: hidden;
        background-repeat: no-repeat;
        background-image: url({{$gamePublicFolder}}/21.png)
    }
    ...
    .bg_main {
        background-position: -949px -93px
    }
    ...
    #splash {
        background-image: url(/history-detail/28f6cc13-65b3-4951-97c7-d653252f5add.jpg);
    ...
    #background-img {
        background-image: url(/history-detail/e29b8499-d357-4851-837a-42c59e98d6c3.jpg);
        background-position: 50%
    }
    ...
    .sprite_main_res {
        background-image: url(/history-detail/https://static.pgsoft-games.com/shared/ad52f8ee3c/e2cf6fa310.663ff.png);
        background-repeat: no-repeat;
    ...
    .footer-image-port {
        background-image: url(/history-detail/blob:https://m.pgsoft-games.com/f55c3e01-e65a-4bc6-9610-9d2f8e0a3307);
        background-position: 50%;
        background-size: cover;
        position: absolute
    }
    ...
    .leaderboard_icon_img {
        background-image: url(/history-detail/a14223fc-738f-42ef-8879-dde954c867d5.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .widget_icon_img {
        background-image: url(/history-detail/91ffce2c-8842-4e66-a57f-ede4b605b559.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .fav_icon_yellow {
        background-image:
            url(/history-detail/download6.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .wallet-plugin-sprite {
        background-image: url(/history-detail/3323e313-f83f-4293-8076-725a831ff8a7.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .tournament_general_packed_2 {
        background-image: url(/history-detail/888f58a8-89d5-459a-8f75-0b5f3428f912.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .wallet-plugin-color-sprite {
        background-image:
            url(/history-detail/download4.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .tournament_lang_packed {
        background-image: url(/history-detail/5a7e3dae-c04f-4b21-8d9a-cab90ce8ce23.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .tournament_general_packed {
        background-image: url(/history-detail/f454f2b3-a075-46d5-b2be-5b42c4b406b3.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .ic_close {
        background-image: url(/history-detail/49a9b6bc-c195-45d3-a57f-145608f312b9.png)
    }

    .menu_close_button {
        background-image: url(/history-detail/c5eb171b-c7b1-4318-bd7c-6e73600b1fa8.png)
    }
    ...
    .ic_coupon {
        background-image:
            url(/history-detail/download7.png);
    ...
    .ic_rollover {
        background-image:
            url(/history-detail/download5.png);
        background-size: 590% 205%;
        height: 60px;
        width: 60px
    }
    ...
    .ic_wallet_open {
        background-image:
            url(/history-detail/download3.png);
        background-size: 590% 205%;
        height: 60px;
        width: 60px
    }
    ...
    .menu_close_button {
        background-image:
            url(/history-detail/download2.png)
    }
    ...
    .gh_common_sprite {
        background-image: url(/history-detail/ca31c34e-78c0-47f9-9835-9644b7a59411.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .gh_card_history_sprite {
        background-image: url(/history-detail/f1823d30-b351-4bbd-9a8f-893bbeb321c6.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .gh_theme_sprite {
        background-image:
            url(/history-detail/download1.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
