...
namespace Slotgen\SlotgenSweetBonanza\Filament\Pages;
...
use Slotgen\SlotgenSweetBonanza\Models\SlotgenGame;
use Slotgen\SlotgenSweetBonanza\Models\SlotgenSweetBonanzaConfig;
use Yepsua\Filament\Forms\Components\RangeSlider;
use Filament\Forms\Components\Select;
use ZipArchive;

class SlotgenSweetBonanzaConfigPage extends Page
{
    use InteractsWithForms;

    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'slotgen-sweetbonanza::filament.pages.config-page';

    public ?array $data = [];

    public SlotgenSweetBonanzaConfig $setting;

    public function mount(): void
    {
        $rtpConfig = SlotgenSweetBonanzaConfig::first();
        if (! empty($rtpConfig)) {
    ...
    public function submit(): void
    {
        ...
        try {
            // dd($this->data);
            $setting = SlotgenSweetBonanzaConfig::first();
            if (! empty($setting)) {
                ...
                // dd($this->data);
                if (SlotgenSweetBonanzaConfig::create($this->data)) {
                    Notification::make()
                        ->title('Setting add')
    ...
    public function extractFile($fileName, $language = 'en')
    {
        ...
        if ($folder != null) {
            ...
            // $data = [
            //     'game_name'        => $name,
            //     'game_class'     => "Slotgen\\SlotgenSweetBonanza\\SlotgenSweetBonanza",
            // ];
            // $slotgen->fill($data);
            // $slotgen->save();
            $gamePrivateFolder = storage_path('app/private/sweet_bonanza');
            $localtionStorage = 'app/private/sweet_bonanza';
            ...
            //File::copy(__DIR__ . '/../../../resources/games/sweetbonanza-logo.png', $gamePublicFolder . '/sweetbonanza-logo.png');
        }
    }
}
