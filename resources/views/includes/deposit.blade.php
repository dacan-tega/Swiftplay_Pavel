        ...
        <div class="modal-content">
            ...
            <div id="qrcode-container">
                ...
                <div class="d-grid mt-2">
                    <button id="copyQrcodePix" class="btn btn-primary" type="button">{{trans('includes.COPY_CODE')}}</button>
                </div>
                <div class="mt-3 text-center">
                    <p><i class="fa fa-spin fa-spinner mr-3"></i> {{trans('includes.Awaiting')}}</p>
                </div>
            </div>

            <form id="depositForm" method="post" action="" class="form-login">
                @csrf
                <h5 class="mb-3 font-bold">{{trans('includes.DEPOSIT')}}</h5>
                ...
                <!-- <div class="input-group mb-3">
                    ...
                    <input type="text" name="cpf" class="form-control cpf" required placeholder="{{trans('includes.ENTER_CPF')}}">
                </div>
                ...
                <div class="d-grid mt-3">
                    <button type="submit" class="btn-primary-theme btn-block w-full mb-3">
                        {{trans('includes.GENERATE_QRCODE')}}
                    </button>
                </div>
            </form>
        </div>
...
@push('scripts')
    ...
    <script>
        ...
        $("#deposit-modal").iziModal({
            title: 'Deposit',
            subtitle: 'Choose or enter the deposit amount',
        ...
        document.getElementById("copyQrcodePix").addEventListener("click", function() {
            ...
            iziToast.show({
                title: 'Success',
                message: 'Pix Key Copied Successfully',
                theme: 'dark',
