                        ...
                        <div style="width: 285px; height: 48px; align-self: start;">
                                <div class="payoutContainer"
                                    ...
                                    <div class="payoutTextContainer"
                                        ...
                                        <div class="payoutTitle" style="font-size: 12px; color: rgb(255, 255, 255); text-align: right;">Rp${symbolWin['win']}</div>
                                    </div>
                                </div>
...
<style>
    ...
    #splash {
        background-image: url(<?php echo $imageBaseUrl ?>/28f6cc13-65b3-4951-97c7-d653252f5add.jpg);
    ...
    #background-img {
        background-image: url(<?php echo $imageBaseUrl ?>/e29b8499-d357-4851-837a-42c59e98d6c3.jpg);
        background-position: 50%
    }
    ...
    .footer-image-port {
        background-image: url(blob:https://m.pgsoft-games.com/f55c3e01-e65a-4bc6-9610-9d2f8e0a3307);
        background-position: 50%;
        background-size: cover;
        position: absolute
    }
    ...
    .leaderboard_icon_img {
        background-image: url(<?php echo $imageBaseUrl ?>/a14223fc-738f-42ef-8879-dde954c867d5.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .widget_icon_img {
        background-image: url(<?php echo $imageBaseUrl ?>/91ffce2c-8842-4e66-a57f-ede4b605b559.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .fav_icon_yellow {
        background-image: url(<?php echo $imageBaseUrl ?>/download6.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .wallet-plugin-sprite {
        background-image: url(<?php echo $imageBaseUrl ?>/3323e313-f83f-4293-8076-725a831ff8a7.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .tournament_general_packed_2 {
        background-image: url(<?php echo $imageBaseUrl ?>/888f58a8-89d5-459a-8f75-0b5f3428f912.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .wallet-plugin-color-sprite {
        background-image: url(<?php echo $imageBaseUrl ?>/download4.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .tournament_lang_packed {
        background-image: url(<?php echo $imageBaseUrl ?>/5a7e3dae-c04f-4b21-8d9a-cab90ce8ce23.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .tournament_general_packed {
        background-image: url(<?php echo $imageBaseUrl ?>/f454f2b3-a075-46d5-b2be-5b42c4b406b3.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .ic_close {
        background-image: url(<?php echo $imageBaseUrl ?>/49a9b6bc-c195-45d3-a57f-145608f312b9.png)
    }

    .menu_close_button {
        background-image: url(<?php echo $imageBaseUrl ?>/c5eb171b-c7b1-4318-bd7c-6e73600b1fa8.png)
    }
    ...
    .ic_chip,
    .ic_coupon {
        background-image: url(<?php echo $imageBaseUrl ?>/download7.png);
    ...
    .ic_free_game,
    .ic_rollover {
        background-image: url(<?php echo $imageBaseUrl ?>/download5.png);
        background-size: 590% 205%;
        height: 60px;
        width: 60px
    }
    ...
    .ic_spin,
    .ic_wallet_open {
        background-image: url(<?php echo $imageBaseUrl ?>/download3.png);
        background-size: 590% 205%;
        height: 60px;
        width: 60px
    }
    ...
    .ic_win,
    .menu_close_button {
        background-image: url(<?php echo $imageBaseUrl ?>/download2.png)
    }
    ...
    .gh_common_sprite {
        background-image: url(<?php echo $imageBaseUrl ?>/ca31c34e-78c0-47f9-9835-9644b7a59411.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .gh_card_history_sprite {
        background-image: url(<?php echo $imageBaseUrl ?>/f1823d30-b351-4bbd-9a8f-893bbeb321c6.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
    ...
    .gh_theme_sprite {
        background-image: url(<?php echo $imageBaseUrl ?>/download1.png);
        background-repeat: no-repeat;
        display: inline-block;
        overflow: hidden
    }
