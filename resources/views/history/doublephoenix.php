...
.pr-dynamic-symbols-sprite {
    background-image: url(<?php echo $imageBaseUrl ?>8045bcba-d010-4a9c-90ab-a5b49b57fb64.png);
    background-repeat: no-repeat;
    display: inline-block;
    overflow: hidden
}
...
/* $CSS-Game-2 */
.pr-symbols-sprite {
    background-image: url(<?php echo $imageBaseUrl; ?>2233bb19-adb8-4fc8-856a-3dbe88a462e3.png);
    background-repeat: no-repeat;
    display: inline-block;
    overflow: hidden;
}
                    ...
                    <div id="game-list-view" class="game-list-view-container"
                        ...
                        <div
                            ...
                            <div id="game-details-view-container"
                                    ...
                                    <div style="position: absolute; z-index: 4; height: inherit; width: inherit;">
                                        <div id="game-list-nav" style="background-color: rgb(36, 36, 46);">
                                            <div id="game-list-nav-bar" class="game-list-nav-bar-vertical"
                                                ...
                                                <div class="game-list-nav-image-container game-list-nav-image-container-slot back-report">
                                                </div>
                                                    ...
                                                    <div class="game-list-nav-row-container ">
                                                        <div id="game-free-spin-nav-label-wrapper"
                                                            ...
                                                            <div id="game-free-spin-nav-label" class="title-top"
                                                                style="color: rgb(247, 186, 101);">{LOG_TITLE}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="game-list-nav-subtitle-label tile-sub"
                                ...
                                <div id="game-detail-spring-wrapper" style="position: absolute; height: 578px;">
                                            ...
                                            <div class="game-list-page"
                                                ...
                                                <div class="reset">
                                                    <div id="transaction-details-container"
                                                        ...
                                                        <div class="transction-detail-item"
                                                            style="display: flex; flex-direction: column; align-items: center; width: 29%;">
                                                            <div id="Transaction-item-value"
                                                                style="text-align: center; display: inline-table; color: rgba(255, 255, 255, 0.6); font-size: 11px; line-height: 24px;">
                                                                {Transaction}</div>
                                                            <div id="Transaction-item-key"
                                                                style="text-align: center; font-size: 11px; color: rgb(247, 186, 101);">
                                                                Transaction</div>
                                                        </div>
                                                        <div class="transction-detail-item"
                                                            style="display: flex; flex-direction: column; align-items: center; width: 21%;">
                                                        ...
                                                        <div class="rcs-custom-scroll " style="height: inherit;">
                                                            <div class="rcs-outer-container" style="height: 100%;">
                                                                ...
                                                                <div class="rcs-inner-container"
                                                                    ...
                                                                    <div
                                                                        style="height: 100%; overflow-y: visible; margin-right: 20px;">
                                                                        <div id="bet-details-container"
                                                                            ...
                                                                            <div id="bet-information-container"
                                                                                ...
                                                                                <div id="rounds-label"
                                                                                    style="font-size: 11px; text-align: center; word-break: break-word; color: rgb(247, 186, 101);">
                                                                                    {ROUND_INFO}</div>
                                                                                <div id="separator"
                                                                            ...
                                                                            <div id="bet-results-container"
                                                                                ...
                                                                                <div id="slot-container"
                                                                                    style="display: flex; align-items: center; position: relative; width: 300px; height: 220px;">
                                                                                    <!---START_TEMPLATE_BODY---->
                                                                                    <div id="slot-item-column-{COLUMN}"
                                                                                        style="position: relative; height: 215px; width: 60px; display: flex; flex-direction: column;">
                                                                                        <!---START_BODY_ITEM---->
                                                                                        <div class="slot-item"
                                                                                            style="width: 60px; height: 65px;">
                                                                                            <span
                                                                                                class="-x-ICON-CSS- pr-dynamic-symbols-sprite s_Symbol_1 -xx-"
                                                                                                style="transform-origin: left top; transform: scale(0.5) translate(-25px, -15px);"></span>
                                                                                        </div>
                                                                                        <!---END_BODY_ITEM---->
                                                                                        <!---START_SAMBLE_BLOCK---->
                                                                                        <div class="slot-item"
                                                                                            style="width: 60px; height: 65px;">
                                                                                            <span
                                                                                                class="pr-symbols-sprite s_Symbol_8"
                                                                                                style="transform-origin: left top; transform: scale(0.5) translate(-25px, -15px);"></span>
                                                                                        </div>
                                                                                        <div class="slot-item"
                                                                                            style="width: 60px; height: 65px;">
                                                                                            <span
                                                                                                class="pr-symbols-sprite s_Symbol_5"
                                                                                                style="transform-origin: left top; transform: scale(0.5) translate(-25px, -15px);"></span>
                                                                                        </div>
                                                                                        <!---END_SAMBLE_BLOCK---->
                                                                                    </div>
                                                                                    ...
                                                                                    <div id="slot-item-column-1"
                                                                                        ...
                                                                                        <div class="slot-item"
                                                                                            style="width: 60px; height: 65px;">
                                                                                            <span
                                                                                                class="pr-symbols-sprite s_Symbol_9"
                                                                                                style="transform-origin: left top; transform: scale(0.5) translate(-25px, -15px);"></span>
                                                                                        </div>
                                                                                        <div class="slot-item"
                                                                                            style="width: 60px; height: 65px;">
                                                                                            <span
                                                                                                class="pr-symbols-sprite s_Symbol_3"
                                                                                                style="transform-origin: left top; transform: scale(0.5) translate(-25px, -15px);"></span>
                                                                                        </div>
                                                                                        <div class="slot-item"
                                                                                            style="width: 60px; height: 65px;">
                                                                                            <span
                                                                                                class="pr-dynamic-symbols-sprite s_Symbol_1"
                                                                                                style="transform-origin: left top; transform: scale(0.5) translate(-25px, -15px);"></span>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div id="slot-item-column-2"
                                                                                        ...
                                                                                        <div class="slot-item"
                                                                                            style="width: 60px; height: 65px;">
                                                                                            <span
                                                                                                class="pr-symbols-sprite s_Symbol_4"
                                                                                                style="transform-origin: left top; transform: scale(0.5) translate(-25px, -15px);"></span>
                                                                                        </div>
                                                                                        <div class="slot-item"
                                                                                            style="width: 60px; height: 65px;">
                                                                                    ...
                                                                                    <div id="slot-item-column-4"
                                                                                        ...
                                                                                        <div class="slot-item"
                                                                                            style="width: 60px; height: 65px;">
                                                                                            <span
                                                                                                class="pr-symbols-sprite s_Symbol_7"
                                                                                                style="transform-origin: left top; transform: scale(0.5) translate(-25px, -15px);"></span>
                                                                                        </div>
                                                                                    </div>
                                                                                    <!---END_SAMBLE_BLOCK---->
                                                                            ...
                                                                            <div id="bet-payout-container"
                                                                                ...
                                                                                <div id="win-multiplier-feature-container"
                                                                                    style="display: flex; width: inherit; height: 48px; align-items: center;">
                                                                                    <label
                                                                                        style="flex: 1 1 auto; text-align: left; font-size: 14px; color: rgb(204, 204, 204);">{MULTIPLY_INFO}</label>
                                                                                </div>
                                                                                <!---START_PAYOUT_INFO---->
                                                                                <div
                                                                                    ...
                                                                                    <div id="payline-container"
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <span
                                                                                                class="pr-symbols-sprite s_-x-Symbol_4-xx-{SYMBOL_NAME}"
                                                                                                style="transform-origin: left top; transform: scale(0.35) translateX(-25px);"></span>
                                                                                        </div>
                                                                                        <div id="payline-desc-wrapper"
                                                                                            style="display: flex; flex-direction: column; flex: 1 1 auto; text-align: left; font-size: 14px; color: rgb(204, 204, 204);">
                                                                                            <label>{SYMBOL_TITLE}</label><label
                                                                                                style="font-size: 11px; color: rgb(156, 155, 155);">{SYMBOL_SUB}</label>
                                                                                        </div>
                                                                                        <div id="payline-labels"
                                                                                            style="display: flex; flex-direction: column;">
                                                                                            <div id="payline-win-value-label"
                                                                                                style="width: 100px; font-size: 14px; color: rgb(204, 204, 204); text-align: right;">
                                                                                                {PAYOUT_TOTAL}</div>
                                                                                            <div id="payline-subvalue-label"
                                                                                                style="width: 100px; font-size: 11px; color: rgb(156, 155, 155); text-align: right;">
                                                                                                {PAYOUT_DESC}
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div id="tooltip-toast"
                                                                                    ...
                                                                                    <div id="tooltip-title"
                                                                                        style="color: rgb(128, 128, 128); font-size: 12px; text-align: left; padding: 0px 8px;">Bet Size x Bet Level x Symbol Payout Values x Way(s) x Multiplier
                                                                                    </div>
                                                                                    <div id="tooltip-desc"
                                                                                        style="font-size: 12px; text-align: left; padding: 0px 8px;">{SIZE} x {LEVEL} x {PAYOUT} x {WAY} x {MULTIPLY}
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                </div>
...
<script>
    ...
    var Ge = "pr-symbols-sprite";
    var Ie = "pr-dynamic-symbols-sprite";
