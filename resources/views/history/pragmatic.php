                ...
                <table class="Table">
                    <thead class="Table__Header">
                        <tr class="Table__Row Table__Row--header">
                            ...
                            <th class="Table__Cell Table__Cell--header Table__Cell--roundId"><span class="Table__Cell--header_text_container"><span class="Table__Cell--header_text">Username # Round</span></span></th>
                            ...
                            <th class="Table__Cell Table__Cell--header Table__Cell--win Table__Cell--align-right"><span class="Table__Cell--header_text_container"><span class="Table__Cell--header_text">Win</span></span></th>
                            <th class="Table__Cell Table__Cell--header Table__Cell--balance"><span class="Table__Cell--header_text_container"><span class="Table__Cell--header_text">After Balance</span></span></th>
                            <th class="Table__Cell Table__Cell--header">
                                <div class="BtnAction">
                                    <svg class="BtnAction__Icon" viewBox="0 0 24 24">
                    ...
                    <tbody class="Table__Body" id="history">
                        <tr class="Table__Row" tabindex="1">
                            <td class="Table__Cell">
                            </td>
                            <td class="Table__Cell Table__Cell--header Table__Cell--roundId"><span class="Table__Cell--header_text_container"><span class="Table__Cell--header_text"><?php echo $order->session_id?> # <?php echo $order->transaction_id ?></span></span></th>
                            <td class="Table__Cell Table__Cell--header Table__Cell--dateTime"><span class="Table__Cell--header_text_container"><span class="Table__Cell--header_text"><?php echo $order->created_at?></span></span></th>
                            <td class="Table__Cell Table__Cell--header Table__Cell--bet"><span class="Table__Cell--header_text_container"><span class="Table__Cell--header_text"><?php echo $order->bet_amount?></span></span></th>
                            <td class="Table__Cell Table__Cell--header Table__Cell--win Table__Cell--align-right"><span class="Table__Cell--header_text_container"><span class="Table__Cell--header_text"><?php echo $order->amount?></span></span></th>
                            <td class="Table__Cell Table__Cell--header Table__Cell--balance"><span class="Table__Cell--header_text_container"><span class="Table__Cell--header_text"><?php echo $order->balance?></span></span></th>
                            <td class="Table__Cell">
                            </td>
                        </tr>
                        <tr class="Table__Row--details Table__Row--expanded">
                            <td id="<?php echo $order->transaction_id?>" class="Table__Cell Table__Cell--details" colspan="7">
                                <div>
                                    <div class="Session">
                                        <div class="<?php echo $game->name ?>" >
                                            <?php  
                                                $resultJson = $detail->result_json;
                                                $uuid = $detail->uuid;
                                                $win = 0;
                                                $drop = 0;
                                                $rowChild = "";
                                            ...
                                            <?php 
                                                for($d = 0; $d < count($resultJson) ; $d++):
                                                    $dataId = $uuid."_".$drop;
                                                    $reel = "";
                                                    $reelPositionTotal = "";
                                                    $reelPositionTotal1 = "";
                                                    $title  = $drop == 0 ? 'Spin' : 'Tumbling';
                                            ?>
                                            
                                            <div class="Action " data-id="<?php echo $dataId ?>">
                                                <div class="Action__HWrap">
                                                    <div class="Action__VWrap">
                                                        <div class="Action__Header">
                                                            <div class="Action__Title"><?php echo $title ?></div>
                                                                    ...
                                                                    <div class="SlotWrap">
                                                                        <div class="SlotWrap__Field">
                                                                            ...
                                                                            <?php 
                                                                                ...
                                                                                $winDrop = [];
                                                                                $lastReel = $resultJson[$d]['new_reel'];
                                                                                for($i = 0; $i < count($resultJson[$d]['win_drop']); $i++){
                                                                                    $winDrop = $resultJson[$d]['win_drop'][$i]['position'];
                                                                                }

                                                                                $totalWin = $resultJson[$d]['win_total'];
                                                                                $winMulti = count($resultJson[$d]['win_drop']) == 0 ? $resultJson[$d]['win_multi'] : $totalWin;
                                                                            ...
                                                                            <?php 
                                                                                for($i = 0; $i < count($lastReel); $i++): 
                                                                                    ...
                                                                                    $reelPosition = "";
                                                                            ?>
                                                                                <div class="ReelsSlot__Reel">
                                                                                    <?php 
                                                                                        for($j = 0; $j < count($lastReel[$i]); $j++): 
                                                                                            $check = $i + $j * 6;
                                                                                            $checkValue = strpos($lastReel[$i][$j] , 'x');
                                                                                    ?>

                                                                                        <?php 
                                                                                            if($checkValue && $checkValue > 0):
                                                                                                $numberMulti = explode($lastReel[$i][$j] , 'x')[0];
                                                                                                $symbolMulti = '';
                                                                                        ...
                                                                                        ?>
                                                                                            <div class="MoneyScatter ">
                                                                                                <img src="/uploads/games/<?php echo $gameFolder ?>/symbols/<?php echo $symbolMulti?>.png" srcset="" alt="<?php echo $symbolMulti?>" class="ReelsSlot__ItemImg">
                                                                                                <div class="MoneyScatter__LabelWrap">
                                                                                                    <div class="MoneyScatter__Label" style="font-size: clamp(0px, 55.3px, 11.06px);"><?php echo $lastReel[$i][$j] ?></div>
                                                                                                    <div class="MoneyScatter__Money" style="font-size: clamp(0px, -275px, 11px);"></div>
                                                                                                </div>
                                                                                            </div>
                                                                                        <?php else: ?>
                                                                                            <?php if(in_array($check+1 , $winDrop)): ?>
                                                                                                <div class="ReelsSlot__Item ReelsSlot__Item--position-<?php echo $check?>">
                                                                                                    <div class="Animation Animation__CrossFade ">
                                                                                                        <div class="Animation__CrossFadeItem Animation__CrossFadeItem--0">
                                                                                                            <img src="/uploads/games/<?php echo $gameFolder?>/symbols/<?php echo $lastReel[$i][$j]?>.png" srcset="" alt="10" class="ReelsSlot__ItemImg">
                                                                                                        </div>
                                                                                                        <div class="Animation__CrossFadeItem Animation__CrossFadeItem--1">
                                                                                                            <img src="/uploads/games/<?php echo $gameFolder?>/symbols/tmb.png" srcset="" alt="tmb" class="ReelsSlot__ItemImg">
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            <?php else: ?>
                                                                                                <div class="ReelsSlot__Item ReelsSlot__Item--position-<?php echo $check?> ReelsSlot__--<?php echo $lastReel[$i][$j]?>">
                                                                                                    <img src="/uploads/games/<?php echo $gameFolder ?>/symbols/<?php echo $lastReel[$i][$j]?>.png" srcset="" alt="<?php echo $lastReel[$i][$j]?>" class="ReelsSlot__ItemImg">
                                                                                                </div>
                                                                                            <?php endif ?>
                                                                                        <?php endif ?>
                                                    ...
                                                    <div class="Action__Result">
                                                        <div class="Action__ResultItem Action__ResultItem--win">
                                                            <div class="Action__ResultValue"><?php echo $resultJson[$d]['win_total']?></div>
                                                            <div class="Action__ResultLabel">Win</div>
                                                        </div>
                                                        <div class="Action__ResultItem ">
                                                            <div class="Action__ResultValue"></div>
                                                            <div class="Action__ResultLabel">Tumbling Win: <?php echo $winMulti ?></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
