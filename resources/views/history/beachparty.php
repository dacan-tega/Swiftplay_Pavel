<?php
$imageBaseUrl = '/games/'.@$result['game_folder'].'/symbols';
?>
<head>
    <!-- jQuery library -->
...
<div id="game-shell" class="game-shell">
                                                ...
                                                <div id="game-list-nav-bar" class="game-list-nav-bar-vertical" style="height: calc(100% - 2px);">
                                                    ...
                                                    <div id="game-list-nav-label-container" class="game-list-nav-label-container-vertical ">
                                                        <div class="game-list-nav-row-container ">
                                                            <div id="game-free-spin-nav-label-wrapper" style="width: 75px;">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var data = {
                data: JSON.parse('<?php echo json_encode($result); ?>'),
            };
            ...
            for (let i = 0; i < items.length; i++) {
                ...
                for (let j = 0; j < countItem; j++) {
                    ...
                    // var betAmount = freeNum > 0 ? 0 : betAmount
                    ...
                    var multilReel1 = item[j]['multi_reel1'] ? item[j]['multi_reel1'] : "";
                    var multilReel1 = multilReel1.toString();
                    var multilReel1F = multilReel1.slice(0,1);
                    var multilReel1L = multilReel1.slice(1,2);
                    // console.log(multilReelBonus);
                    var multilReel2 = item[j]['multi_reel2'] ? item[j]['multi_reel2'] : "";
                    var multilReel2 = multilReel2.toString();
                    var multilReel2F = multilReel2.slice(0,1);
                    var multilReel2L = multilReel2.slice(1,2);
                    var multilReel3 = item[j]['multi_reel3'] ? item[j]['multi_reel3'] : "";
                    var multilReel3 = multilReel3.toString();
                    var multilReel3F = multilReel3.slice(0,1);
                    var multilReel3L = multilReel3.slice(1,2);
                    var profit = item[j]['profit'];
                    var betAmount = item[j]['total_bet'];
                    var xReel1 = multilReel1F ? "mul_x" : "";
                    ...
                    var multilReel = `
                        <div id="multiplier-container"
                            style="position: absolute; left: 0px; right: 0px; margin: 0px auto; height: 90px; width: 150px; display: flex; top: 25px;">
                            <div style="flex: 1 1 0%; transform: scale(0.5); transform-origin: center top;">
                                <div style="position: absolute; display: flex; left: 50%; margin: 25px auto 0px; transform: translateX(-35%);">
                                    <div class="multiplier_num ${xReel1}" style="width: 35px; margin-top: 10px;"></div>
                                    <div class="multiplier_num mul_${multilReel1F}"></div>
                                    <div class="multiplier_num mul_${multilReel1L}"></div>
                                </div>
                            </div>
                            <div style="flex: 1 1 0%; transform: scale(0.5); transform-origin: center top;">
                                <div style="position: absolute; display: flex; left: 50%; margin: 0px auto; transform: translateX(-30%);">
                                    <div class="multiplier_num ${xReel2}" style="width: 35px; margin-top: 10px;"></div>
                                    <div class="multiplier_num mul_${multilReel2F}"></div>
                                    <div class="multiplier_num mul_${multilReel2L}"></div>
                                </div>
                            </div>
                            <div style="flex: 1 1 0%; transform: scale(0.5); transform-origin: center top;">
                                <div style="position: absolute; display: flex; left: 50%; margin: 25px auto 0px; transform: translateX(-20%);">
                                    <div class="multiplier_num ${xReel3}" style="width: 35px; margin-top: 10px;"></div>
                                    <div class="multiplier_num mul_${multilReel3F}"></div>
                                    <div class="multiplier_num mul_${multilReel3L}"></div>
                                </div>
                            </div>
                        </div>
                        `
                                ...
                                <div class="payoutContainer"
                                    ...
                                    <div class="payoutImageContainer" style="min-width: 50px; width: 50px; height: inherit; position: relative;">
                                        <span class="${symbolWin['name']} symbol_atlas"
                                            style="display: block; transform-origin: left top; transform: scale(0.39); margin-left: -10px; margin-top: -10px;"></span>
                                    </div>
                                    <div class="payoutDescContainer"
                ...
                `
                    ...
                    for (let c = 0; c < countLastReel + 1; c++) {
                        ...
                        for (let d = 0; d < symbolReel[c].length; d++) {
                            ...
                            style="display: block; position: absolute; transform-origin: left top; margin-top: -10px; margin-left: -10px; transform: scaleX(0.56) scaleY(0.56); z-index: 1;"></span>
                            <div id="win-highlight-item"><span class="wh symbol_atlas" style="display: block; position: absolute; transform-origin: left top; margin-top: -10px; margin-left: -10px; transform: scaleX(0.5) scaleY(0.5); z-index: 1;"></span></div>
                            </div>
                        ...
                        if (c == 0) {
                            ...
                            <div id="slot-item-column"
                                style="position: relative; min-width: 50px; width: 50px; height: inherit; display: flex; flex-direction: column;top: 104px;right: 9px">` +
                                slotItem + `</div>`;
                        } else if (c == 4) {
                            slotColumn = slotColumn + `
                            <div id="slot-item-column"
                            ...
                            slotColumn = slotColumn + `
                            <div id="slot-item-column"
                                style="position: relative; min-width: 50px; width: 50px; height: inherit; display: flex; flex-direction: column;top: 85px;right: 5px">` +
                                slotItem + `</div>`;
                        } else if (c == 3) {
                            slotColumn = slotColumn + `
                            <div id="slot-item-column"
                            ...
                            slotColumn = slotColumn + `
                            <div id="slot-item-column"
                                style="position: relative; min-width: 50px; width: 50px; height: inherit; display: flex; flex-direction: column;top: 70px;">` +
                                slotItem + `</div>`;
                        }
                    ...
                    transactionItem = `
                                    ...
                                    <div id="transaction-details-container"
                                        ...
                                        <div class="transaction-detail-item"
                                            ...
                                            <div id="Bet(Rp)-item-key" style="text-align: center; font-size: 11px; color: rgb(224, 111, 54);">Bet(Rp)
                                            </div>
                                        </div>
                                        <div class="transaction-detail-item"
                                            ...
                                            <div id="Profit(Rp)-item-key" style="text-align: center; font-size: 11px; color: rgb(224, 111, 54);">
                                                Profit(Rp)</div>
                                        </div>
                                        <div class="transaction-detail-item"
                                            ...
                                            <div id="Balance(Rp)-item-key" style="text-align: center; font-size: 11px; color: rgb(224, 111, 54);">
                                                Balance(Rp)</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class=" rcs-custom-scroll " style="height: inherit;">
                                        <div class="rcs-outer-container" style="height: 100%;">
                                            ...
                                            <div class="rcs-inner-container" style="height: 100%; margin-right: -17px;">
                                                <div style="height: 850px; overflow-y: scroll; margin-right: 0px;">
                                                    <div id="bet-details-container" style="display: flex; flex-direction: column;">` + betInformation + `<div id="slot-main-view" style="display: flex; width: 300px; margin: auto;">
                                                            <div id="bet-results-container"
                                                                style="display: flex; position: relative; height: 315px;width: 300px; margin: auto auto 10px; flex-direction: column;">
                                                                <div><span class="history_bg bg_main" id="slot-background"
                                                                        style="display: block; position: absolute; transform-origin: left top; transform: scaleX(0.54) scaleY(0.52); top: -12px; left: -8px; z-index: 0; margin-top: 6px; margin-left: 3px;"></span>
                                                                </div>
                                                                <div id="train-symbols-container"
                                                                    style="position: relative; display: flex; justify-content: center; height: inherit; margin-top: 0px;top: -15px">` + trainSymbol + `
                                                                    </div>
                                                                <div id="space" style="height: 4px;"></div>
                                                                <div id="symbols-container"
                                                                    style="position: relative; display: flex; justify-content: center; height: inherit; margin-top: 0px;top: -15px">` + slotColumn + `
                                                                    </div>` +
                        multilReel + `
                                                            </div>
...
<style>
    ...
    #game-shell {
        transform: scale(calc(var(--construct-scale) *2.21));
    ...
    .symbol_10 {
        background-position: -1695px -1px
    }
