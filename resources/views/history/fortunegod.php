...
.s_Symbol_0 {
    ...
    overflow: hidden;
    background-repeat: no-repeat;
    background-size: 301px 279px;
    background-image: url(<?php echo $imageBaseUrl ?>6.png);
    width: 226px;
    min-width: 267px;
    height: 247px;
    min-height: 208px;
...
.symbol_atlas {
    ...
    overflow: hidden;
    background-repeat: no-repeat;
    background-image: url(<?php echo $imageBaseUrl ?>3.png)
}
...
.s_Symbol_5 {
    ...
    min-height: 140px;
    background-size: 538px 738px;
    background-position: -301px -242px
}
...
.ui_reel_atlas {
    ...
    background-image: url(<?php echo $imageBaseUrl ?>12.png)
}
...
<div id="game-shell" class="game-shell">
    <div id="game-overlay">
        ...
        <div id="game-history-container1"
                                                                            ...
                                                                            <div id="bet-details-container"
                                                                                ...
                                                                                <div id="background-container"
                                                                                    ...
                                                                                    <div id="symbols-container"
                                                                                        ...
                                                                                        <div id="slot-item-column"
                                                                                            style="position: relative; height: 232px; width: 95px; display: flex; flex-direction: column; align-items: center; margin-top: -60px;">
                                                                                            <!---START_BODY_ITEM---->
                                                                                            <div id="slot-item"
                                                                                                style="width: 85px; height: 74px;">
                                                                                                <span
                                                                                                    class="-x-ICON-CSS- symbol_7_1x1 symbol_atlas -xx-"
                                                                                                    style="display: block; position: absolute; transform-origin: left top; transform: scale(0.38); margin-top: 15px; margin-left: -1px;"></span>
                                                                                            </div>
                                                                                            <!---END_BODY_ITEM---->
                                                                                            <!---START_SAMBLE_BLOCK---->
                                                                                            <div id="slot-item"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div style="left: 90%; border-width: 6px; border-style: solid; border-color: transparent transparent rgb(70, 70, 83); border-image: initial; height: 0px; width: 0px; position: absolute; pointer-events: none; bottom: 98%;"></div>																							
                                                                                    ...
                                                                                    <div id="tooltip-toast"
                                                                                        ...
                                                                                        <div id="tooltip-title"
                                                                                            style="color: rgb(128, 128, 128); font-size: 12px; text-align: left; padding: 0px 8px;">{Calc_payout}
                                                                                        </div>
                                                                                        <div id="tooltip-desc"
